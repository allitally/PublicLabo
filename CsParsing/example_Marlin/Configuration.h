...
#define CUSTOM_MACHINE_NAME "A10M"
 ...
 */
#define BLTOUCH  //3Dtouch---1
#if ENABLED(BLTOUCH)
  #define BLTOUCH_DELAY 675   // (ms) Enable and increase if needed //3Dtouch---2
#endif
...
//
#define Z_SAFE_HOMING  //3Dtouch---4
...
#define HOMING_FEEDRATE_Z  (6*60)//3Dtouch---5
